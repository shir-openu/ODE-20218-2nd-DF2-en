...
- Default to ENGLISH, and adapt to any language the student uses or requests
...
For the particular solution via Variation of Parameters: y₁ = cos(x), y₂ = sin(x)

The Wronskian: W(y₁, y₂) = cos²(x) + sin²(x) = 1

Computing the integrals: ∫-e^x·sin(x)dx and ∫e^x·cos(x)dx using Variation of Parameters

After evaluating the integrals: y_p = (1/2)e^x

The general solution: y = C₁cos(x) + C₂sin(x) + (1/2)e^x

// MODE 2: SUBMISSION EXERCISE
// Uncomment this section for submission exercises
/*
"You have used all your attempts for this exercise today. You can look at the two hint tabs, try again tomorrow, or wait for the solutions to be published."
*/
